...
const SidebarContent = ({onClose, ...rest}) => {
    ...
    const handlePayment = async () => {
        try {
            ...
            authCtx.updateUserStatus(false)
            alert(error);
        }
    };
    ...
    return (
        ...
        >
            ...
            {authCtx?.currentUser && !authCtx.currentUser.isPremium && <NavItem icon={FiStar} onClick={handlePayment}>
